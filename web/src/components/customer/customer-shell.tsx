...
import { LayoutDashboard, ClipboardList, Route, FileText, MessageCircle, Star, Bell, User } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/customer/messages", key: "messages", icon: MessageCircle, exact: false },
  { href: "/customer/reviews", key: "reviews", icon: Star, exact: false },
