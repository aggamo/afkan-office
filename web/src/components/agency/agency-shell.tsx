...
const NAV_ITEMS = [
  { href: "/agency", key: "dashboard", icon: LayoutDashboard, exact: true },
  { href: "/agency/authorizations", key: "authorizations", icon: ClipboardCheck, exact: false },
  { href: "/agency/invoices", key: "invoices", icon: FileText, exact: false },
] as const;
